...
\bibitem{flask}
``Flask Documentation,'' 
[Online]. Available: https://flask.palletsprojects.com/en/stable/

\bibitem{werkzeug}
``Werkzeug Documentation,'' 
[Online]. Available: https://werkzeug.palletsprojects.com/en/stable/

\bibitem{socketio}
``Documentação SocketIO,'' 
[Online]. Available: https://socket.io/pt-br/docs/v4/

\bibitem{flasksocketio}
``Flask-SocketIO Documentation,'' 
[Online]. Available: https://flask-socketio.readthedocs.io/en/latest/index.html
